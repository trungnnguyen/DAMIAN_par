...
C     CALL CLEAR(B,NTENS,NDOFEL)
C     CALL CLEAR(XJ,2,2)
C     CALL CLEAR(XJI,2,2)
C     CALL CLEAR(P,2,NNE)
...
C     CALL CLEAR(SF,NTENS,NDOFEL)
C     CALL CLEAR(SFT,NDOFEL,NTENS)
C     CALL CLEARV(SN,9)
C     CALL CLEAR(AUX1,NDOFEL,NDOFEL)
